...
namespace WebApplication2.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AppointmentID,AppointmentDateTime,PatientID,DoctorID,AppointmentReason,Status")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AppointmentID,AppointmentDateTime,PatientID,DoctorID,AppointmentReason,Status")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
